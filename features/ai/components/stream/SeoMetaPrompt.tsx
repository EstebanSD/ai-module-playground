...
export function SeoMetaPrompt() {
  ...
  const { stream, cancel } = useStreamSeoMeta();
  ...
  return (
    <div className="p-4 grid grid-cols-1 gap-4">
      <PromptDescription
        desc="Generates SEO metadata from the text using a streaming response."
